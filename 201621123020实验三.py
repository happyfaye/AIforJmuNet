...
class GeneticAlgorithm(object):
    ...
    def __init__(self, cross_rate, mutation_rate, n_population, n_iterations, password):
        ...
        self.password = password                                            # 要得到的目标字符串
        self.password_size = len(self.password)                             # 目标的长度
        self.password_ascii = np.fromstring(self.password, dtype=np.uint8)  # 将NDA转换至ASCII方便进行变异操作
...
def main():
    password = 'hello,201621123020'     # 要破解的密码
