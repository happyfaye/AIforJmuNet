...
best = [72, 101, 108, 108, 111, 44, 50, 48, 49, 54, 50, 49, 49, 50, 51, 48, 54, 55]

def get_ran(b=33,e=126):
    """
    33-126刚好是所有可打印ascii码
    """
...
class Population:
    ...
    def __init__(self,much=5000,aim=[72, 101, 108, 108, 111, 44, 50, 48, 49, 54, 50, 49, 49, 50, 51, 48, 54, 55]):
        """
        初始化种群，5000
        """
        self.group = []
...
def main():
    ...
    while i <= 500:
        ...
        str1 = 'Generation: {:^4}  '.format(i)
        str2 = '{}'.format(po.get_best().to_asc())
