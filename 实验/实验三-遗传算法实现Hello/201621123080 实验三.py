...
best = [72, 101, 108, 108, 111, 44, 50, 48, 49, 54, 50, 49, 49, 50, 51, 48, 56, 48]
...
class Population:
    ...
    def __init__(self,much=5000,aim=[72, 101, 108, 108, 111, 44, 50, 48, 49, 54, 50, 49, 49, 50, 51, 48, 56, 48]):
        """
        初始化种群，默认种群数量5000，指定序列为 Hello,201621123080
        """
        self.group = []
