...
TARGET_PHRASE = 'Hello,201621123028'       # target DNA
...
class GA(object):
    ...
    def evolve(self):
        ...
        for parent in pop:  # for every parent
            ...
            parent[:] = child
        self.pop = pop
    def function(pop_size,DNA_SIZE):
        temporary=[]
        function1=[]
        temporary=translation(pop_size,DNA_SIZE)
        
        for i in range(len(temporary)):
            x=temporary[i]*max_value/(math.pow(2,DNA_SIZE)-1)
