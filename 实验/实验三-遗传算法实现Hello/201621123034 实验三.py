...
class Chromosome:
    ...
    _target_gene = "Hello,201621123034"
...
class Population:
    ...
    def __init__(self, size=1000, crossover=0.8, elitism=0.1, mutation=0.03):
...
if __name__ == "__main__":
        ...
        vals=[]
        maxGenerations = 1000
        pop = Population(size=1000, crossover=0.8, elitism=0.1, mutation=0.3)
